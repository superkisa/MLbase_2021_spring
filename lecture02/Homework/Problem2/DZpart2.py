...
print(accuracy_score(y_true, y_predict, percent=None))
print(precision_score(y_true, y_predict, percent=None))
print(recall_score(y_true, y_predict, percent=None))
print(lift_score(y_true, y_predict, percent=None))
print(f1_score(y_true, y_predict, percent=None))
